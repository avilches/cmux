...
final class BrowserPanel: Panel, ObservableObject {
    ...
    /// backdrop, clear the browser's native fill too. Otherwise blank tabs and
    /// the under-page loading area add an extra native layer over the shared
    /// backdrop and look opaque compared with terminal panels.
    private func applyWebViewBackground(color: NSColor) {
        if !Self.drawsConfiguredWebViewBackground() {
    ...
    static func drawsConfiguredWebViewBackground() -> Bool {
